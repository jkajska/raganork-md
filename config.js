...
module.exports = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "commander",
    BOT_NAME: process.env.BOT_NAME || 'commander',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'commander;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
